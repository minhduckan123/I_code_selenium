...
cursor = conn.cursor()
try:
    cursor.execute("""CREATE TABLE shopee_data (
        name VARCHAR(300),
        price_1 VARCHAR(50),
        price_2 VARCHAR(50),
        address VARCHAR(100),
...
def craw(n):
    for i in range(1,n+1):
        ...
        print()
        cursor.execute("INSERT INTO shopee_data VALUES (%s,%s,%s,%s,%s,%s)", (name_obiject,price_1,price_2,address_object,vote_object,sold_object))
        conn.commit()
